const buildMakeIngredient = ({validator}) => {
  return ({
    ...
    return Object.freeze({ 
      ...
      getProtein: () => protein,
      getFat: () => fat,
      getMicroNutrients: () => [...microNutrients.map(nutrient => ({...nutrient}))],
      getAll: () => ({
        id, name, group, energy, carbohydrates, protein, fat, microNutrients: [...microNutrients.map(nutrient => ({...nutrient}))],
      })
    });
  };
};
